...
* **Actor:** Entrenador Pokémon
* **Descripción:** El usuario desea organizar sus viajes de captura optimizando sus recursos (Pokeballs). Para ello, necesita saber qué Pokémon están disponibles en una región específica y saber qué tan difícil será capturarlos basándose en su capture_rate
* **Flujo:** El sistema permite filtrar la lista de Pokémon por su región de origen y tipo elemental, mostrando el ratio de captura para que el entrenador decida si la expedición es viable.
